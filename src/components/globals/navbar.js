        ...
        (
            <div className="dropdown_curtain">
                <div className="dropdown_menu">
                    <header>
                        <li>
                            <FontAwesomeIcon icon={faXmark} className='nav_icon' onClick={toggleDropdown}/>
                        </li>
                    </header>
                    <li className="dropdown_item" ><FontAwesomeIcon icon={faHouse} className='nav_icon'/>Home</li>
                    <li className="dropdown_item" ><FontAwesomeIcon icon={faFilm} className='nav_icon'/>Catalog</li>
                </div>
            </div>
